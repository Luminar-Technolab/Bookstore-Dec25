...
function Profile() {
  ...
  return (
    ...
    <div style={{width:'230px',height:'230px',borderRadius:'50%',marginTop:'-130px',marginLeft:'70px'}} className="bg-white p-3">
      <img style={{width:'200px',height:'200px',borderRadius:'50%'}} src={dp==""?"https://cdn.pixabay.com/photo/2023/02/18/11/00/icon-7797704_1280.png":dp.startsWith("https://lh3.googleusercontent.com/")?dp:`${axiosInstance.defaults.baseURL}/uploads/${dp}`} alt="user" />
    </div>
    ...
    <div className="md:px-40">
      ...
      <div className="flex justify-center items-center my-8 font-medium text-lg">
        ...
        <p onClick={()=>setCurrentTab(2)} className={currentTab==2?'p-4 border-gray-200 border-l border-t border-r rounded cursor-pointer':'p-4 border-gray-200 border-b rounded cursor-pointer'}>Upload Books Status</p>
