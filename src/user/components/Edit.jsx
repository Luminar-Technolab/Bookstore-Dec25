...
function Edit() {
  ...
  return (
    <div>
        {/* button */}
        <button onClick={()=>setOffCanvas(true)} className="bg-black text-white p-2 flex items-center rounded border hover:bg-white hover:text-black"> <FaPen className='me-2'/> Edit</button>
        {/* offcanvas */}
       { 
        offCanvas &&
        <div>
